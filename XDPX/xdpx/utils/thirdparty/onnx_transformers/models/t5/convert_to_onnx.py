...
from xdpx.utils.thirdparty.onnx_transformers.benchmark_helper import Precision, create_onnxruntime_session, prepare_environment, setup_logger
...
def parse_arguments():
    ...
    parser.add_argument("--merge", required=False, action="store_true")
...
def main():
    ...
    with torch.no_grad():
        merge_encoder_and_decoder_init = args.merge  # Merge encoder and decoder initialization into one model is recommended.
