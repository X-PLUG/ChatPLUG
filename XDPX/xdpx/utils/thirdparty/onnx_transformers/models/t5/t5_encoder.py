...
class T5EncoderInputs:
    def __init__(self, input_ids, attention_mask):
        ...
        self.input_ids: torch.Tensor = input_ids.type(torch.int32)
        self.attention_mask: torch.Tensor = attention_mask.type(torch.int32)
...
class T5EncoderHelper:
    ...
    def export_onnx(
        ...
        torch_onnx_export(
            ...
            dynamic_axes={
                ...
                "hidden_states": {0: "batch_size", 1: "sequence_length", 2: hidden_size},
            },
            opset_version=12,
    ...
    def verify_onnx(model: T5Encoder, ort_session: InferenceSession, device: torch.device):
        ...
        max_diff = numpy.amax(numpy.abs(torch_outputs.cpu().numpy() - ort_outputs['hidden_states'].cpu().numpy()))
