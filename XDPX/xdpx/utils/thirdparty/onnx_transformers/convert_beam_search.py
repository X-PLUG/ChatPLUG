...
import onnx
import torch
from xdpx.utils.thirdparty.onnx_transformers.benchmark_helper import Precision
from onnx import helper
from onnx import onnx_pb as onnx_proto
from packaging import version
from transformers import GPT2Config, T5Config, MT5Config

from xdpx.utils.thirdparty.onnx_transformers.models.gpt2.convert_to_onnx import main as convert_gpt2_to_onnx
from xdpx.utils.thirdparty.onnx_transformers.models.gpt2.gpt2_helper import PRETRAINED_GPT2_MODELS

config: Union[GPT2Config, T5Config, MT5Config] = None
...
def test_torch_performance(args, model, input_ids, attention_mask, eos_token_id, pad_token_id, bad_words_ids):
    ...
    from xdpx.utils.thirdparty.onnx_transformers.benchmark_helper import get_latency_result
...
def test_model(args, use_vocab_mask: bool = False, sentences: List[str] = None):
    ...
    print("test_data_dsir", test_data_dir)
    from xdpx.utils.thirdparty.onnx_transformers.bert_test_data import output_test_data
