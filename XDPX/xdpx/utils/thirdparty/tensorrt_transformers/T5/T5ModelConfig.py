...
class T5ModelTRTConfig(NNConfig):
    ...
    TARGET_MODELS = ["t5-small", "t5-base", "t5-large", "t5-3b", "mt5-small","mt5-base", "mt5-large", "zh-t5-base"]
    NUMBER_OF_LAYERS = {TARGET_MODELS[0]: 6, TARGET_MODELS[1]: 12, TARGET_MODELS[2]: 24, TARGET_MODELS[3]: 24,
                        TARGET_MODELS[4]: 6, TARGET_MODELS[5]: 12, TARGET_MODELS[6]: 24,TARGET_MODELS[7]: 12,
                        }
    MAX_SEQUENCE_LENGTH = {
        TARGET_MODELS[0]: 512,
        TARGET_MODELS[1]: 768,
    ...
    VOCAB_SIZE = {
        TARGET_MODELS[0]: 32128,
        TARGET_MODELS[1]: 32128,
        TARGET_MODELS[2]: 32128,
        TARGET_MODELS[3]: 32128,
        TARGET_MODELS[4]: 250112,
        TARGET_MODELS[5]: 250112,
        TARGET_MODELS[6]: 250112,
        TARGET_MODELS[7]: 50000,
    }
