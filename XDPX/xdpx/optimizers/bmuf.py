...
class BMUFOptimizer(Optimizer):
    ...
    def register(options):
        options.register(
            Argument('block_lr', default=1., doc='block learning rate for bmuf'),
            Argument('block_momentum', default=0.875, doc='block momentum for bmuf'),
            Argument('global_sync_iter', default=50, doc='Iteration for syncing global model'),
            Argument('warmup_iterations', default=500, doc='warmup iterations for model to broadcast'),
            Argument('use_nbm', default=False, doc='Specify whether you want to use classical BM / Nesterov BM'),
            Argument('average_sync', default=False, doc='Specify whether you want to average the local momentum after each sync'),
            domain='bmuf'
        )
